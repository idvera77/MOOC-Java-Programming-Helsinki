...
* **Programación Orientada a Objetos (OOP) Avanzada:** Encapsulamiento, herencia, polimorfismo y uso extensivo de interfaces y clases abstractas.
* **Persistencia y Bases de Datos:** Manejo de bases de datos relacionales (**SQL/H2**) mediante el patrón de diseño **DAO** (Data Access Object).
* **Estructuras de Datos:** Manejo avanzado de `ArrayList`, `HashMap`, `HashSet` y procesamiento de colecciones mediante **Streams** y **Lambdas**.
* **Lógica de Negocio:** Separación clara entre la lógica del programa y la interfaz de usuario (UI) siguiendo patrones de arquitectura limpia.
